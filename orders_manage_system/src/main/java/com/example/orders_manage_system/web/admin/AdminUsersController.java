...
import com.example.orders_manage_system.common.ValidationGroups;
import com.example.orders_manage_system.entity.User;
import com.example.orders_manage_system.service.UserService;
...
public class AdminUsersController {
    ...
    public String update(@Validated(ValidationGroups.Update.class) User editUser, BindingResult result, Model model, RedirectAttributes ra) {
